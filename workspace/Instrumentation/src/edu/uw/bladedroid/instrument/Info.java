...
public class Info {
    ...
    public static final String onCreateSubSignature = "void onCreate(android.os.Bundle)";
    public static final String onStartSubSignature = "void onStart()";
    public static final String onResumeSubSignature = "void onResume()";
    public static final String onPauseSubSignature = "void onPause()";
    public static final String onStopSubSignature = "void onStop()";
    public static final String onDestroySubSignature = "void onDestroy()";
    public static final String onKeyLongPressSubSignature = "boolean onKeyLongPress(int,android.view.KeyEvent)";
    public static final String onKeyDownSubSignature = "boolean onKeyDown(int,android.view.KeyEvent)";
    public static final String onKeyUpSubSignature = "boolean onKeyUp(int,android.view.KeyEvent)";
